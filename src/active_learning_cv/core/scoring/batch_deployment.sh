...
az ml online-endpoint create --name image-realtime-scoring -f realtime_score.yml
# <create_compute>
...
az ml batch-deployment create --name image-batch-scoring --endpoint-name %ENDPOINT_NAME% --file batch_score.yml --set-default
# </create_batch_deployment_set_default>
...
# </check_batch_deployment_detail>
folder:azureml://datastores/mltraining/paths/MIT_Indoor/indoorCVPR_09/Images/bakery
# <start_batch_scoring_job>
JOB_NAME=$(az ml batch-endpoint invoke --name $ENDPOINT_NAME --input-path folder:azureml://datastores/mltraining/paths/MIT_Indoor/indoorCVPR_09/Images/bakery --query name -o tsv)
# </start_batch_scoring_job>
